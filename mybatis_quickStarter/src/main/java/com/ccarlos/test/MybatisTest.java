...
//        sqlSession.insert("user.saveUser", user);
        sqlSession.insert("com.ccarlos.dao.IUserDao.saveUser", user);
...
//        sqlSession.update("user.updateUser", user);
        sqlSession.update("com.ccarlos.dao.IUserDao.updateUser", user);
        sqlSession.commit();
    ...
    public void test4() throws IOException {
        ...
        sqlSession.delete("com.ccarlos.dao.IUserDao.deleteUser", 6);
        sqlSession.commit();
